...
public class UpdateEmployee extends JFrame implements ActionListener, ItemListener {
	...
	UpdateEmployee(){
		super("Update Employee's Information");
		setLayout(null);
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource()==b1){
            ...
            String e = t6.getText();
            String p = t7.getText();
            String qry = "update tblEmployee set name='"+n+"', gender='"+g+"', email='"+e+"', phone='"+p+"', address='"+a+"', city='"+c+"', state='"+s+"' where id="+c2.getSelectedItem();
        ...
        if(ae.getSource()==b2){
            try{
                Conn c1 = new Conn();
                c1.s.executeUpdate("delete from tblEmployee where id="+c2.getSelectedItem());
	...
	public void itemStateChanged(ItemEvent ie) {
		try{
            Conn c1 = new Conn();
            ResultSet rs = c1.s.executeQuery("select * from tblEmployee where id="+c2.getSelectedItem());
